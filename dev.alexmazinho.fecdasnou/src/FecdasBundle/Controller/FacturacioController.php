...
class FacturacioController extends BaseController {
	...
	public function migracomandesAction(Request $request) {
		...
		$current = date('Y');
		$maxnums = array(
				'maxnumcomanda' => $this->getMaxNumFactura($current, BaseController::COMANDES), 
				'maxnumrebut' => $this->getMaxNumFactura($current, BaseController::REBUTS)
		);
	...
	public function getMaxNumFactura($year, $tipus) {
		$em = $this->getDoctrine()->getManager();
